...
let machineStrip = document.querySelector('.machine_strip');
let machineHead = document.querySelector('.machine_head');
let machineState = document.querySelector('.machine_state');
...
// addStateButton.addEventListener('click', function() {
	...
	// 	// MathJax.Hub.Queue(['Typeset', MathJax.Hub, 'machine_strip']);
